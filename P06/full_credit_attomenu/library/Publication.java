...
public class Publication {
    ...
    /**
     * Reports an attempt to check out a Publication that is already checked out.
     *
     * @since         1.1
     */
    ...
    /**
     * Reports an attempt to check in a Publication that is already checked in.
     *
     * @since         1.1
     */
    ...
    public Publication(BufferedReader br) throws IOException {
        ...
        this.loanedTo = (br.readLine().equals("null") ? null
                      : br.readLine());
        this.dueDate  = (br.readLine().equals("null") ? null
                      : LocalDate.of(Integer.parseInt(br.readLine()),
    ...
    public void save(BufferedWriter bw) throws IOException {
        ...
        bw.write(author + '\n');
        bw.write("" + copyright + '\n');
        bw.write((loanedTo == null) ? "null\n" 
                 : "\n" + loanedTo + '\n');
        bw.write((dueDate == null) ? "null\n" 
                 :  "\n" + dueDate.getYear() + '\n' 
                         + dueDate.getMonthValue() + '\n'
                         + dueDate.getDayOfMonth() + '\n');
    }
    /**
     * True if this publication is currently checked out to a patron
     *
     * @since              1.1
     */
...
\     * @since              1.0
     */
    public void checkOut(String patron) throws AlreadyCheckedOutException {
        if(loanedTo != null) throw new AlreadyCheckedOutException();
        loanedTo = patron;
     ...
     * @since              1.0
     */
    public void checkIn() throws AlreadyCheckedInException {
        if(loanedTo == null) throw new AlreadyCheckedInException();
        loanedTo = null;
        dueDate = null;
    }
